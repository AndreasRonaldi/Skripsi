...
switch (variabel) {
	case nilai1:
		...
		break;
	case nilai2:
		// kode blok yang akan dijalankan hingga ditemukan break jika variabel sama dengan nilai2
		break;
	default:
...
function functionName($parameter1, $parameter2, ...) {
	...
	return $nilai; // Mengembalikan nilai ke pemanggil fungsi
			  ...
			  \end{lstlisting}
		            ...
		            Kode \ref{kode:5:fungsi_notasi} merupakan notasi untuk membuat fungsi dalam PHP. Dimulai dengan \textit{keyword function}, dilanjutkan dengan nama fungsinya, selanjutnya terdapat tanda kurung `()' yang didalamnya dapat diberikan parameter, dan terakhir diikuti oleh tanda kurung kurawal `{}'. Parameter dalam fungsi itu bersifat opsional, dan digunakan untuk menerima variable dari luar kedalam fungsi tersebut. Tetapi saat fungsi dipanggil kembali jika memiliki parameter maka pemberian paramater untuk fungsi itu bersifat wajib, jika tidak memiliki parameter yang tepat maka php \textit{interpreter} akan mengeluarkan error. Pada kode \ref{kode:5:fungsi_notasi} dalam blok kode, ada sebuah \textit{keyword} \verb|return| yang berarti fungsi akan mengembalikan nilai \verb|$nilai| (yang dapat diganti menjadi apapun) ke pemanggil fungsi tersebut.
...
class Dog {
	...
	public function bark() {
		echo $this->name . ' barked!';
		            ...
		            \begin{lstlisting}[language={php}, caption={Contoh Kelas}, label={kode:5:class_call_ex}]
$robert = new Dog();
$robert->name = 'Robert';
...
class Blog_controller extends CI_Controller {
	...
	\item \textbf{Melakukan studi literatur mengenai editor kode Ace\footnote{Dokumentasi Ace. https://ace.c9.io/(10 Desember 2024)}.} \\
	      ...
	      % TODO: Tambahin penjelasan tentang Session, Selector, Selection, Commands
		      ...
		      \item \textbf{Controller}
		            ...
		            \begin{itemize}
			            \item \verb|Assignments.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/assignments.png}
			            ...
			            \item \verb|Dashboard.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/dashboard.png}
			            ...
			            \item \verb|Halloffame.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/hof.png}
			            ...
			            \item \verb|Install.php| \\
			                  ...
			                  \begin{figure}[H]
				                  \centering
				                  \includegraphics[width=0.5\textwidth]{views/install.png}
			            ...
			            \item \verb|Login.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/login.png}
			            ...
			            \item \verb|Logs.php| \\
			                  ...
			                  \begin{figure}[H]
				                  \centering
				                  \includegraphics[width=0.5\textwidth]{views/log.png}
			            ...
			            \item \verb|Moss.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/moss.png}
			            ...
			            \item \verb|Notifications.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/notifications.png}
			            ...
			            \item \verb|Problems.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/problem.png}
			            ...
			            \item \verb|Profile.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/profile.png}
			            ...
			            \item \verb|Queue.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/queue.png}
			            ...
			            \item \verb|Rejudge.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/rejudge.png}
			            ...
			            \item \verb|Scoreboard.php| \\
			                  ...
			                  \begin{figure}[H]
				                  \centering
				                  \includegraphics[width=0.5\textwidth]{views/scoreboard.png}
			            ...
			            \item \verb|Settings.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/settings.png}
			            ...
			            \item \verb|Submissions.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|the_final()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/final_submissions.png}
				                  ...
				                  \item \verb|all()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/all_submissions.png}
			            ...
			            \item \verb|Submit.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/submit.png}
			            ...
			            \item \verb|User.php| \\
			                  ...
			                  \begin{itemize}
				                  ...
				                  \item \verb|index()| \\
				                        ...
				                        \begin{figure}[H]
					                        \centering
					                        \includegraphics[width=0.5\textwidth]{views/users.png}
...
{% endblock navigation %}
	...
	\item \textbf{Memodelkan dan merencanakan perubahan pada structur website dan database pada SharIF-Judge.} \\
	      {\bf Status :} Ada sejak rencana kerja skripsi.\\
	      {\bf Hasil :} Sudah dilakukan perencaan perubahan.
...
\begin{enumerate}
	...
	\item Memodelkan dan merencanakan perubahan pada structur website dan database pada SharIF-Judge.
