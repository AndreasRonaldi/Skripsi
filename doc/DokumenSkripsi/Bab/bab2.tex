...
Untuk mengintegrasikan \textit{library} Ace dalam sebuah web page, Ace perlu ditanam dalam sebuah web page. Salah satu cara untuk menanam Ace ke dalam sebuah web page adalah dengan mem-\textit{build library} dan menaruhnya dalam direktori lokal dan dipanggil dalam web page yang diinginkan dengan cara seperti berikut:
